...
wire [4:0]func5;
    ...
    //Zicsr Extension
    assign out_signal[54] = ((opcode == 7'b1110011) && (func3 == 3'd1)) ? 1'b1 : 1'b0;       //CSRRW
    assign out_signal[55] = ((opcode == 7'b1110011) && (func3 == 3'b10)) ? 1'b1 : 1'b0;      //CSRRS
    assign out_signal[56] = ((opcode == 7'b1110011) && (func3 == 3'b011)) ? 1'b1 : 1'b0;     //CSRRC
